...
const Login = () => {
    ...
    return (
        <View style={styles.container}>
            {os === 'ios' ? <StatusBar barStyle='light-content' /> : <StatusBar hidden={true} />}
            ...
            <View style={styles.logIn}>
                ...
                <View style={styles.bottom}>
                    <TouchableOpacity onPress={() => navigation.navigate('FORGOTPASSWORKSCREEN')}>
                        <Text style={{ fontSize: 17, marginVertical: 15 }}>
                            Forgot your password?
                        </Text>
                    </TouchableOpacity>
                    <View style={{ flexDirection: 'row' }}>
                        <TouchableOpacity onPress={() => navigation.navigate('CREATEACOUNSCREEN')}>
